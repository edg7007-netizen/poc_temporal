...
-- 1. Installments: 12-month installment loan, daily interest accrual, 18% APR, single withdrawal
INSERT INTO loan_products (
    ...
    'Installments', 'INSTALLMENTS', 'DAILY', 0.180000, NULL,
    12, FALSE, 50000.00, 500.00,
    30, 0.050000, TRUE
);

-- 2. CDD (Custom Due Date): 3-month single-payment loan, 8% flat upfront interest, single withdrawal
INSERT INTO loan_products (
    name, product_type, interest_accrual_method, annual_interest_rate, flat_interest_rate,
    number_of_payment_cycles, allows_multiple_withdrawals, max_loan_amount, min_loan_amount,
    cooldown_period_days, late_fee_rate, active
) VALUES (
    'CDD (Custom Due Date)', 'CDD', 'FIXED_UPFRONT', 0.320000, 0.080000,
